...
class DatabaseClient:
    ...
    def read_db(self):
        # Read in sentiment table from database
        cur = self.con.cursor()
    ...
    def insert_db(self, df):
        # Insert moving average values to table
        cur = self.con.cursor()
...
class SentimentProcessor:
    ...
    def calculate_moving_averages(self, overall_headlines):
        """
        Calculate moving average score based on previous sentiment
        :param overall_headlines:
        :return:
        """

        # Convert dateid and timeid to datetime
